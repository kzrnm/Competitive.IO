...
{
#pragma warning restore CA1819,CA1815,CA1034
    public class PropertyConsoleReader
    {
        ...
        public ref struct RepeatReader
        {
            ...
            readonly int count;
            public RepeatReader(PropertyConsoleReader cr, int count) { this.cr = cr; this.count = count; }
            public T[] Select<T>(Func<PropertyConsoleReader, T> factory) { var arr = new T[count]; for (var i = 0; i < count; i++) arr[i] = factory(cr); return arr; }
            public T[] Select<T>(Func<PropertyConsoleReader, int, T> factory) { var arr = new T[count]; for (var i = 0; i < count; i++) arr[i] = factory(cr, i); return arr; }
        ...
        {
            readonly PropertyConsoleReader cr;
            public SplitReader(PropertyConsoleReader cr) { this.cr = cr; }
