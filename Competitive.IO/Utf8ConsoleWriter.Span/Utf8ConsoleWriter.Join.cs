...
namespace Kzrnm.Competitive.IO
{
    ...
    public static class Utf8ConsoleWriterJoin
    {
        ...
        [MethodImpl(256)] public static W WriteLineJoin(this W w, params object[] col) => w.WriteMany(' ', col);
        /// <summary>
        /// Write joined <paramref name="col"/> to the output stream.
        /// </summary>
        /// <returns>this instance.</returns>
        [MethodImpl(256)] public static W WriteLineJoin<T>(this W w, T[] col) => w.WriteMany(' ', col);
        /// <summary>
        ...
        /// </summary>
        /// <returns>this instance.</returns>
        [MethodImpl(256)] public static W WriteLineJoin<T>(this W w, Span<T> col) => w.WriteMany(' ', (ReadOnlySpan<T>)col);
        /// <summary>
        /// Write joined <paramref name="col"/> to the output stream with end of line.
        /// </summary>
        /// <returns>this instance.</returns>
        [MethodImpl(256)] public static W WriteLineJoin<T>(this W w, ReadOnlySpan<T> col) => w.WriteMany(' ', col);

        /// <summary>
        /// Write joined <paramref name="col"/> to the output stream.
        /// </summary>
        /// <returns>this instance.</returns>
        [MethodImpl(256)] public static W WriteLineJoin<T>(this W w, IEnumerable<T> col) => w.WriteMany(' ', col);
