...
namespace Kzrnm.Competitive.IO
{
    ...
    public sealed class UnixUtf8ConsoleWriter(int bufferSize) : IDisposable
#else
    /// <summary>
    /// Output Writer
    /// </summary>
    public sealed class UnixUtf8ConsoleWriter : IDisposable
#endif
    {
        ...
        /// </summary>
        /// <param name="bufferSize">Output buffer size</param>
        public UnixUtf8ConsoleWriter(int bufferSize)
        {
        ...
        /// <para>Wrapper of stdout</para>
        /// </summary>
        public UnixUtf8ConsoleWriter() : this(1 << 12) { }

        /// <summary>
        /// Flush output stream.
        /// </summary>
        [M(256)]
        public void Flush() { Uu8.Write(buf.AsSpan(0, len)); len = 0; }
        ...
        public W Write<T>(T v)
        {
            ...
            else if (v is IUnixUtf8ConsoleWriterFormatter)
            {
                ((IUnixUtf8ConsoleWriterFormatter)v).Write(this);
                return this;
            }
            else
    ...
    /// Formatter
    /// </summary>
    public interface IUnixUtf8ConsoleWriterFormatter
    {
        /// <summary>
