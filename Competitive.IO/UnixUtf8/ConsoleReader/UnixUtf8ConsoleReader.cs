...
namespace Kzrnm.Competitive.IO
{
    ...
    public class UnixUtf8ConsoleReader(int bufferSize)
    {
    ...
    /// Input Reader
    /// </summary>
    public class UnixUtf8ConsoleReader
    {
        /// <summary>
        /// <para>Wrapper of stdin</para>
        /// </summary>
        /// <param name="bufferSize">Input buffer size</param>
        public UnixUtf8ConsoleReader(int bufferSize)
        {
        ...
        /// <para>Wrapper of stdin</para>
        /// </summary>
        [M(256)] public UnixUtf8ConsoleReader() : this(1 << 12) { }
        ...
        private void FillEntireNumberImpl()
        {
            ...
            len -= pos;
            pos = 0;
            var numberOfBytes = Uu8.Read(buf.AsSpan(len));
            if (numberOfBytes == 0)
                buf[len++] = 10;
...
#pragma warning restore IDE0079
        ...
        public string String()
        {
            ...
            return Encoding.UTF8.GetString(sb, 0, c);
        }
        ...
        {
            var (sb, c) = InnerBlock<AC>();
            return Encoding.UTF8.GetChars(sb, 0, c);
        }
