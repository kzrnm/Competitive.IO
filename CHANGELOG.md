...
## [3.3.0] - 2026-09-14
### Added
- Add new operator to RepeatReader. `RepeatReader + int/uint/long/ulong`

## [3.2.0] - 2026-09-06
### Added
- Cast `Asciis` to `Span<Ascii>`

## [3.1.2] - 2026-08-24
### Changed
- Make `RepeatReader.Select(Span<T>, Func)` read only `Count` elements

## [3.1.1] - 2026-08-22
### Added
- `Asciis` implements `IComparable`

## [3.0.2] - 2026-07-30
### Changed
- Fix `Utf8ConsoleWriter.Write(ReadOnlySpan<byte>)`
