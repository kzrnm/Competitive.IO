...
namespace Kzrnm.Competitive.IO
{
    public class PropertyConsoleReaderTests
    {
        ...
        private readonly PropertyConsoleReader cr;
        static readonly string input;
        static PropertyConsoleReaderTests()
        {
        ...
        public PropertyConsoleReaderTests()
        {
            stream = new MemoryStream(new UTF8Encoding(false).GetBytes(input));
            cr = new PropertyConsoleReader(stream, new UTF8Encoding(false));
        }
        ...
        public async Task DoublePeriod() => await Task.Run(() =>
        {
            ...
            var cr = new PropertyConsoleReader(stream, new UTF8Encoding(false));
